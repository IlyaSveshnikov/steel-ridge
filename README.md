...
- **Анимированный hero** — саморисующийся SVG-чертёж стропильной фермы (`stroke-dashoffset`),
  светящаяся scan-линия и blueprint-сетка; всё на чистом CSS/SVG, отключается при `prefers-reduced-motion`.
